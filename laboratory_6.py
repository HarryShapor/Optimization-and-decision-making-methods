'''
Программа для решения задачи линейного программирования симплекс-методом.
Решает задачу оптимизации производства мебели (столов и шкафов) с учетом
ограничений по количеству доступной древесины разных пород.
Определяет оптимальное количество столов и шкафов для производства,
чтобы получить максимальный доход при заданных ограничениях по ресурсам.
'''
