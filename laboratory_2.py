'''
Программа для оценки рангов проектов экспертами.
Использует два метода: метод средних баллов и метод медианных рангов.
Эксперты оценивают проекты, и программа определяет итоговый ранг
каждого проекта на основе этих оценок.
'''
