'''
Программа для решения задачи методом экспертных оценок.
Используется для выбора лучшей альтернативы на основе оценок экспертов.
В данной задаче эксперты оценивают несколько альтернатив, и программа
определяет лучшую альтернативу на основе весов целей и оценок экспертов.
'''
