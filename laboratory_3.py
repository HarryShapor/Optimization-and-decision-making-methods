'''
Программа для решения транспортной задачи методом северо-западного угла.
Помогает найти оптимальный план перевозок товаров от складов к потребителям
с минимальными затратами на транспортировку.
'''
