'''
Программа для решения задачи упаковки контейнеров.
Использует алгоритм "первый подходящий по убыванию" для распределения
предметов по контейнерам с учетом их веса и максимальной вместимости контейнера.
'''
