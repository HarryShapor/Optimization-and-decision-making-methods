'''
Программа для решения задачи о маневрировании локомотива.
Реализует продукционное правило перестановки вагонов: Le1e2e3 => Le1e3e2.
Помогает найти последовательность маневров для перевода состава из одного
порядка вагонов в другой с минимальным количеством операций.
'''
