'''
Программа для определения породы кошки по её характеристикам.
Содержит базу данных пород кошек с их характеристиками и позволяет
определить породу кошки на основе ответов на вопросы о её внешнем виде
и поведении.
'''
